...
resdir = paste0(Sys.getenv('CS_HOME'),'/MigrationDynamics/Results/Exploration/20170428_gridwealthsigma/')
dir.create(resdir)
...
for(indic in indics){
  ...
  ggsave(paste0(resdir,'varyingwealthsigma_indic',indic,'.pdf'),width=30,height = 20,units='cm')
}
