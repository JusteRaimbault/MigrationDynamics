...
\item A number of new migrants, proportional to Gibrat growth rate, enter the region. They lean on social network (guanxi) to first settle in the city and agglomerate following a preferential attachment by place of origin.
