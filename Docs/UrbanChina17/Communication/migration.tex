...
impact of varying economic structure

Strategies de l'etat via : entreprises ; hukou policies
...
\cite{reuillon2013openmole,schmitt2014half}

\cite{cottineau2015incremental}

\cite{florida2008rise}

\cite{gottman1961megalopolis}

\cite{wilensky1999netlogo}

\cite{zhang2013measuring}
\cite{fan2005modeling}
\cite{zhang2003rural}

\cite{de2007netlogo}

\cite{xie2007simulating}
\cite{silveira2006agent}
\cite{fernandez2005characterizing} 
